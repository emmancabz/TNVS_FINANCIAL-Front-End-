    ...
    <div className="p-8">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 bg-primary-50 rounded-lg border border-primary-200">
            <h3 className="font-semibold text-gray-900 mb-2">Auto-block Duplicate DV Requests</h3>
            <p className="text-sm text-gray-600">
          ...
          <div className="p-4 bg-primary-50 rounded-lg border border-primary-200">
            <h3 className="font-semibold text-gray-900 mb-2">Auto-generate Disbursement Voucher No.</h3>
            <p className="text-sm text-gray-600">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            <h3 className="font-semibold text-gray-900 mb-2">Auto-update GL after Approval/Payment</h3>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            <h3 className="font-semibold text-gray-900 mb-2">Auto-update AP when Unpaid</h3>
            <p className="text-sm text-gray-600 mb-3">
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-600">XYZ Services Co.</td>
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-600">Tech Solutions Ltd.</td>
